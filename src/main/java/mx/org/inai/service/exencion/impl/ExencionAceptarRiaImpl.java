...
/**
 * The Class ExencionAceptarRia.
 *
 * @author A. Juarez
 */
@Strategy(tipoExencion = TipoExencion.ACEPTAR_RIA)
public class ExencionAceptarRiaImpl extends ExencionAbstract<String> {
	...
	public ExencionResponseDTO<String> registrar(ExencionRequestDTO peticion, String folio) {
		...
		try {
			...
			peticion.setEtapa(Constantes.RIAADA);
